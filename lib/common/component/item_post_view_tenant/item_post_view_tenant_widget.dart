...
import 'item_post_view_tenant_model.dart';
export 'item_post_view_tenant_model.dart';

class ItemPostViewTenantWidget extends StatefulWidget {
  const ItemPostViewTenantWidget({
    super.key,
    required this.postView,
  });

  final PostRoomViewRow? postView;

  @override
  State<ItemPostViewTenantWidget> createState() =>
      _ItemPostViewTenantWidgetState();
}

class _ItemPostViewTenantWidgetState extends State<ItemPostViewTenantWidget> {
  late ItemPostViewTenantModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ItemPostViewTenantModel());
                            ...
                            return Wrap(
                              ...
                              children: List.generate(
                                ...
                                return ItemUtilityAndFurnitureWidget(
                                  key: Key(
                                      'Keyq36_${wrapIndex}_of_${wrapRoomFurnishingsViewRowList.length}'),
                                  isShowDeleted: false,
