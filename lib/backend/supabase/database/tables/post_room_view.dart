...
class PostRoomViewTable extends SupabaseTable<PostRoomViewRow> {
  @override
  String get tableName => 'post_room_view';

  @override
  PostRoomViewRow createRow(Map<String, dynamic> data) => PostRoomViewRow(data);
}

class PostRoomViewRow extends SupabaseDataRow {
  PostRoomViewRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => PostRoomViewTable();
