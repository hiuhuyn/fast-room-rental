...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryText = const Color(0xB38B8585);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF4F5F6);
  ...
  late Color cBorder = Color(0xAD898989);
  late Color hover = Color(0xFFEFEFEF);
  late Color shadow = Color(0x26A5A5A5);
}
